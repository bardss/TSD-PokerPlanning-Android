...
object ServiceProvider {
    ...
    var dynamicAddressService: DynamicAddressApi? = null
        get() = if (field == null) ServiceFactory.createRetrofitService(DynamicAddressApi::class.java, DYNAMIC_ADDRESS_ENDPOINT) else field

    var usersService: UsersApi? = null
       get() = if (field == null) ServiceFactory.createRetrofitService(UsersApi::class.java, SERVICE_ENDPOINT) else field
